...
//    shaders["simple"] = new Shader("resources/shaders/simple_vert.glsl", "resources/shaders/simple_frag.glsl");
//    shaders["skin"] = new Shader("resources/shaders/skin_vert.glsl", "resources/shaders/skin_frag.glsl");

    models["billiards_stick"] = new Model("resources/models/cue.obj");
    models["billiards_table"] = new Model("resources/models/table4.obj");
    models["billiards_ball"] = new Model("resources/models/ball.obj");
//    models["data3"] = new Model("data/bigvegas_BodyGeo.obj");
    models["data"] = new Model("resources/models/cat.obj");
    models["floor"] = new Model("resources/models/floor4.obj");
    
    models["1"] = new Model("resources/models/1.obj");
    models["2"] = new Model("resources/models/2.obj");
    models["win"] = new Model("resources/models/win.obj");
    models["lose"] = new Model("resources/models/lose.obj");
//    models["victory"] = new Model("resources/models/untitled.obj");
//    models["data2"] = new Model("data2/JabCross_Maria_J_J_Ong.obj");
}
